# yousef n8n
[![yousef n8n: Arabic-first, mobile-optimized web automation platform](./public/social_preview_index.jpg)](https://bolt.diy)

Welcome to yousef n8n, an Arabic-first, mobile-optimized web automation platform.
...
1. **Build the Docker Image**:
   ...
   docker build . --target yousef-n8n-development
   ```
